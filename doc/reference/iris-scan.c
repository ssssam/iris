...
extern GType iris_scheduler_get_type (void);
extern GType iris_lfscheduler_get_type (void);
extern GType iris_gmainscheduler_get_type (void);
extern GType iris_queue_get_type (void);
extern GType iris_wsscheduler_get_type (void);
extern GType iris_service_get_type (void);
extern GType iris_message_get_type (void);
extern GType iris_arbiter_get_type (void);
extern GType iris_coordination_arbiter_get_type (void);
extern GType iris_thread_get_type (void);
extern GType iris_port_get_type (void);
extern GType iris_receiver_get_type (void);
extern GType iris_rrobin_get_type (void);
extern GType iris_wsqueue_get_type (void);
extern GType iris_stack_get_type (void);
extern GType iris_lfqueue_get_type (void);
extern GType iris_queue_get_type (void);
extern GType iris_task_get_type (void);
extern GType iris_process_get_type (void);
extern GType iris_progress_monitor_get_type (void);
extern GType gtk_iris_progress_dialog_get_type (void);
extern GType gtk_iris_progress_info_bar_get_type (void);

#ifdef GTK_IS_WIDGET_CLASS
#include <gtk/gtk.h>
#endif
GType object_types[23];
...
get_object_types (void)
{
    ...
    gint i = 0;
    object_types[i++] = iris_scheduler_get_type ();
    object_types[i++] = iris_lfscheduler_get_type ();
    object_types[i++] = iris_gmainscheduler_get_type ();
    object_types[i++] = iris_queue_get_type ();
    object_types[i++] = iris_wsscheduler_get_type ();
    object_types[i++] = iris_service_get_type ();
    object_types[i++] = iris_message_get_type ();
    object_types[i++] = iris_arbiter_get_type ();
    object_types[i++] = iris_coordination_arbiter_get_type ();
    object_types[i++] = iris_thread_get_type ();
    object_types[i++] = iris_port_get_type ();
    object_types[i++] = iris_receiver_get_type ();
    object_types[i++] = iris_rrobin_get_type ();
    object_types[i++] = iris_wsqueue_get_type ();
    object_types[i++] = iris_stack_get_type ();
    object_types[i++] = iris_lfqueue_get_type ();
    object_types[i++] = iris_queue_get_type ();
    object_types[i++] = iris_task_get_type ();
    object_types[i++] = iris_process_get_type ();
    object_types[i++] = iris_progress_monitor_get_type ();
    object_types[i++] = gtk_iris_progress_dialog_get_type ();
    object_types[i++] = gtk_iris_progress_info_bar_get_type ();
    object_types[i] = 0;
...
/* The output files */
const gchar *signals_filename = "./iris.signals.new";
const gchar *hierarchy_filename = "./iris.hierarchy.new";
const gchar *interfaces_filename = "./iris.interfaces.new";
const gchar *prerequisites_filename = "./iris.prerequisites.new";
const gchar *args_filename = "./iris.args.new";
