 ...
 * will last until task execution has completed or been cancelled.
 *
 ...
 * probably crash because @task was freed when cancelled).
 */
void
 ...
 * task to periodically check the cancelled state with iris_task_was_canceled()
